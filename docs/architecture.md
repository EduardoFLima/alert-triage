...
![Triage and its adapters](diagrams/triage.drawio.svg)
...
![Investigation, the crew, and the MCP server](diagrams/investigation.drawio.svg)
...
![Notification and its channels](diagrams/notification.drawio.svg)
...
![Configuration and its sources](diagrams/configuration.drawio.svg)
