...
is the first-pass legwork a knowledgeable human would do, and the conclusion
drawn across it: which signals an incident needs, what each reports, and what
they add up to. It hands back a hypothesis for a human to judge, never a
verdict and never an action.
