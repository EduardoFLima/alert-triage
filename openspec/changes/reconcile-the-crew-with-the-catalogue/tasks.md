...
- [x] 2.1 In `tests/unit/investigation/adapters/crew/test_what_the_apm_specialist_looks_for.py`,
...
- [x] 2.2 In the same file, assert the instruction tells the specialist what to
...
- [x] 2.3 Assert the instruction's example of something cited as an aggregate no
...
- [x] 3.1 In `tests/unit/investigation/adapters/crew/test_a_declaration_and_its_instruction_agree.py`,
...
- [x] 4.1 In `tests/unit/investigation/adapters/crew/test_what_the_trace_specialist_looks_for.py`,
...
- [x] 4.2 In the same file, assert the Preview branch permits and names
...
- [x] 5.1 In `tests/unit/investigation/adapters/crew/test_what_the_infrastructure_specialist_looks_for.py`,
...
- [x] 5.2 In the same file, assert the instruction states the order — a
...
- [x] 6.1 Update the two mentions of `search_datadog_service_dependencies` in
...
- [x] 8.2 `openspec validate reconcile-the-crew-with-the-catalogue --strict`.
- [x] 8.3 Nothing in `README.md` names a specialist's tools, so nothing there
